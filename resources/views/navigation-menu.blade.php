                ...
                <div class="ms-3 relative text-black-800">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                                @if (Auth::check())
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-bold rounded-md text-black bg-[#7011B8] hover:bg-[#590f9b] focus:outline-none transition ease-in-out duration-150">
                                        {{ Auth::user()->name }}
