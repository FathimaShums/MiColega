                        ...
                        <div class="bg-white p-6 rounded-lg w-1/3">
                            ...
                            <form method="POST" action="{{ route('submit.skill.request') }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="file" name="proof[]" id="proof" class="mt-1 block w-full border-gray-300 rounded-md" multiple>
                                </div>
                                @foreach ($skills as $skill)
                                    <input type="hidden" name="skill_id[]" value="{{ $skill->id }}">
                                @endforeach
                                <div class="flex justify-end">
                                    <button type="button" @click="showModal = false" class="bg-gray-500 text-black px-4 py-2 rounded mr-2 hover:bg-gray-600">
                                        Cancel
                                    </button>
